export default {
  ...
  9300572: {
    message: 'PERCENTUAL COMISSAO PERMANENCIA INFORMADO MAIOR QUE O PERMITIDO',
    status: 'refused'
  },
  9300573: {
  ...
  9300586: {
    message: 'INFORME TODOS OS CAMPOS PARA COMISSAO DE PERMANENCIA',
    status: 'refused'
  },
  9300587: {
  ...
  9300589: {
    message: 'CODIGO DO BANCO DIFERENTE DE 237',
    status: 'refused'
  },
  9300590: {
    message: 'VL ACUMULADO ABAT./DESC./BONIF. MAIOR OU IGUAL VL TITULO',
    status: 'refused'
  },
  9300591: {
    message: 'NEGOCIACAO NAO PODE REGISTRAR TITULO',
    status: 'refused'
  },
  9300592: {
    message: 'QUANTIDADE EXCESSIVA DE CASAS DECIMAIS',
    status: 'refused'
  },
  9300593: {
    message: 'NOSSO NUMERO INFORMADO JA EXISTE NA BASE DE TITULO PENDENTE',
    status: 'refused'
  },
  9300594: {
    message: 'VALOR DE IOF INVALIDO',
    status: 'refused'
  },
  9300595: {
    message: 'DATA DE EMISSAO DEVE SER MENOR QUE A DATA DE VENCIMENTO',
    status: 'refused'
  },
  9300596: {
    message: 'DATA DE EMISSAO DEVE SER MENOR OU IGUAL A DATA DE REGISTRO',
    status: 'refused'
  },
  9300597: {
    message: 'NAO EXISTE PRACA COBRADORA PARA ESTE TITULO',
    status: 'refused'
  },
  9300598: {
    message: 'TIPO DE BOLETO E-MAIL, INFORMAR O ENDERECO DE E-MAIL DO SACADO',
    status: 'refused'
  },
  9300599: {
  ...
  93005112: {
    message: 'DADOS MINIMOS PARA REGISTRO NAO INFORMADOS',
    status: 'refused'
  },
  93005113: {
